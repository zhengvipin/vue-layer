...
// EXTERNAL MODULE: ./node_modules/layui-layer/layer.js
var layui_layer_layer = __webpack_require__("e8bf");
var layer_default = /*#__PURE__*/__webpack_require__.n(layui_layer_layer);

// CONCATENATED MODULE: ./packages/drag.js
/**
 * 实现拖拽
 * @param options
...
// 重写layer的open方法
const origin_layerOpen = layer_default.a.open
layer_default.a.open = function(options) {
    ...
    if (type === 1 && typeof content === 'object') {
        ...
        options.success = function(layero, layerid) {
            // 渲染目标组件
            const Component = external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend(content)
...
/* harmony default export */ var packages_0 = (layer_default.a);
